...
struct ComplexObject_
{
  ...
  _score_type score;
   ...
   typedef  ::extended_object_detection::ExtractedInfo_<ContainerAllocator>  _extracted_info_type;
...
struct MD5Sum< ::extended_object_detection::ComplexObject_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xfa224b9c30007427ULL;
  static const uint64_t static_value2 = 0xe3d41721a134e56dULL;
};
...
struct Printer< ::extended_object_detection::ComplexObject_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::extended_object_detection::ComplexObject_<ContainerAllocator>& v)
  {
    ...
    s << indent << "extracted_info: ";
    s << std::endl;
    Printer< ::extended_object_detection::ExtractedInfo_<ContainerAllocator> >::stream(s, indent + "  ", v.extracted_info);
    s << indent << "rect: ";
    s << std::endl;
