...
"""autogenerated by genpy from extended_object_detection/SetObjectsRequest.msg. Do not edit."""
import codecs
import sys
...
class SetObjectsRequest(genpy.Message):
  _md5sum = "58d90aa277946aa2923de4e9d2804806"
  _type = "extended_object_detection/SetObjectsRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetObjectsRequest, self).__init__(*args, **kwds)
...
def _get_struct_2B():
    ...
    return _struct_2B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from extended_object_detection/SetObjectsResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SetObjectsResponse(genpy.Message):
  _md5sum = "67cdd51ca1859f10c723484b0bc5b1b6"
  _type = "extended_object_detection/SetObjectsResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetObjectsResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_I():
    global _struct_I
    return _struct_I
class SetObjects(object):
  _type          = 'extended_object_detection/SetObjects'
  _md5sum = '7e842254cbe0d0dd775c05000053aba0'
  _request_class  = SetObjectsRequest
  _response_class = SetObjectsResponse
