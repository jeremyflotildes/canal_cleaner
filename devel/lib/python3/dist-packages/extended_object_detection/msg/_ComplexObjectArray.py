...
class ComplexObjectArray(genpy.Message):
  _md5sum = "422b800450e196e64ae39e229e083188"
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.complex_objects:
        ...
        _x = _v4
        buff.write(_get_struct_2i().pack(_x.x, _x.y))
        length = len(_v2.cornerTranslates)
        buff.write(_struct_I.pack(length))
        for val3 in _v2.cornerTranslates:
          _x = val3
        ...
        for val2 in val1.objects:
          ...
          _x = _v14
          buff.write(_get_struct_2i().pack(_x.x, _x.y))
          length = len(_v12.cornerTranslates)
          buff.write(_struct_I.pack(length))
          for val4 in _v12.cornerTranslates:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v15 = val2.contour
          length = len(_v15.image_points)
          buff.write(_struct_I.pack(length))
          for val4 in _v15.image_points:
            _x = val4
            buff.write(_get_struct_2i().pack(_x.x, _x.y))
          length = len(_v15.contourTranslates)
          buff.write(_struct_I.pack(length))
          for val4 in _v15.contourTranslates:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v16 = val2.track
          _x = _v16
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v17.values.append(val3)
        _v18 = val1.rect
        _v19 = _v18.left_bottom
        _x = _v19
        start = end
        end += 8
        ...
        for i in range(0, length):
          ...
          _v18.cornerTranslates.append(val3)
        _v21 = val1.transform
        ...
        for i in range(0, length):
          ...
          for i in range(0, length):
            ...
            (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
            _v28.cornerTranslates.append(val4)
          _v31 = val2.contour
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          ...
          for i in range(0, length):
            ...
            (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
            _v31.contourTranslates.append(val4)
          _v32 = val2.track
          _x = _v32
          start = end
          end += 5
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.complex_objects:
        ...
        _x = val1.score
        buff.write(_get_struct_d().pack(_x))
        _v33 = val1.extracted_info
        length = len(_v33.keys)
        buff.write(_struct_I.pack(length))
        for val3 in _v33.keys:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v33.values)
        buff.write(_struct_I.pack(length))
        for val3 in _v33.values:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        _v34 = val1.rect
        _v35 = _v34.left_bottom
        _x = _v35
        buff.write(_get_struct_2i().pack(_x.x, _x.y))
        _v36 = _v34.right_up
        _x = _v36
        buff.write(_get_struct_2i().pack(_x.x, _x.y))
        length = len(_v34.cornerTranslates)
        buff.write(_struct_I.pack(length))
        for val3 in _v34.cornerTranslates:
          _x = val3
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v37 = val1.transform
        ...
        for val2 in val1.objects:
          ...
          _x = val2.score
          buff.write(_get_struct_d().pack(_x))
          _v40 = val2.extracted_info
          length = len(_v40.keys)
          buff.write(_struct_I.pack(length))
          for val4 in _v40.keys:
            length = len(val4)
            if python3 or type(val4) == unicode:
              val4 = val4.encode('utf-8')
              length = len(val4)
            buff.write(struct.Struct('<I%ss'%length).pack(length, val4))
          length = len(_v40.values)
          buff.write(_struct_I.pack(length))
          for val4 in _v40.values:
            length = len(val4)
            if python3 or type(val4) == unicode:
              val4 = val4.encode('utf-8')
              length = len(val4)
          ...
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
          _v44 = val2.rect
          _v45 = _v44.left_bottom
          _x = _v45
          buff.write(_get_struct_2i().pack(_x.x, _x.y))
          _v46 = _v44.right_up
          _x = _v46
          buff.write(_get_struct_2i().pack(_x.x, _x.y))
          length = len(_v44.cornerTranslates)
          buff.write(_struct_I.pack(length))
          for val4 in _v44.cornerTranslates:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v47 = val2.contour
          length = len(_v47.image_points)
          buff.write(_struct_I.pack(length))
          for val4 in _v47.image_points:
            _x = val4
            buff.write(_get_struct_2i().pack(_x.x, _x.y))
          length = len(_v47.contourTranslates)
          buff.write(_struct_I.pack(length))
          for val4 in _v47.contourTranslates:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v48 = val2.track
          _x = _v48
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v49.values.append(val3)
        _v50 = val1.rect
        _v51 = _v50.left_bottom
        _x = _v51
        start = end
        end += 8
        (_x.x, _x.y,) = _get_struct_2i().unpack(str[start:end])
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v50.cornerTranslates.append(val3)
        _v53 = val1.transform
        ...
        for i in range(0, length):
          ...
          for i in range(0, length):
            ...
            (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
            _v60.cornerTranslates.append(val4)
          _v63 = val2.contour
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          ...
          for i in range(0, length):
            ...
            (_x.x, _x.y,) = _get_struct_2i().unpack(str[start:end])
            _v63.image_points.append(val4)
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v63.contourTranslates = []
          for i in range(0, length):
            val4 = geometry_msgs.msg.Vector3()
            _x = val4
            start = end
            ...
            (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
            _v63.contourTranslates.append(val4)
          _v64 = val2.track
          _x = _v64
          start = end
          end += 5
