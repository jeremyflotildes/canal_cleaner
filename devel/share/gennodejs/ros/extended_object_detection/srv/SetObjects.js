...
class SetObjectsRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetObjectsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetObjectsRequest
    let len;
    let data = new SetObjectsRequest(null);
  ...
  static datatype() {
    ...
    return 'extended_object_detection/SetObjectsRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetObjectsRequest(null);
...
class SetObjectsResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetObjectsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetObjectsResponse
    let len;
    let data = new SetObjectsResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'extended_object_detection/SetObjectsResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetObjectsResponse(null);
...
module.exports = {
  ...
  Response: SetObjectsResponse,
  md5sum() { return '7e842254cbe0d0dd775c05000053aba0'; },
  datatype() { return 'extended_object_detection/SetObjects'; }
};
